		...
		<b-collapse id="collapse-like" class="mt-2">
			<div v-if="getIsAddableLikeArticle">
				<b-card bg-variant="light">
					...
					>
						...
						<b-form-group label-cols-sm="3" label="URL:" label-align-sm="right">
						...
						>
							<b-form-input v-model="recommendation" />
						</b-form-group>
			...
			<div v-else>
				<b-card bg-variant="light">
					...
					<!--
						<p>
							現在{{ getNumberOfLikeArticle }}記事が登録されています。（上限３記事）
						</p>
					-->
					<p>
					...
					<b-table :items="obtainLikeArticles" :fields="fields" responsive="sm">
						...
						<template v-slot:row-details="row">
							<b-card>
								...
								<b-button size="sm" variant="primary" @click="confirm(row.item)">
									編集を確定
								</b-button>
							</b-card>
						</template>
